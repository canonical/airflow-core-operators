...
from charm import AirflowTriggererCharm
...
@pytest.fixture
def airflow_triggerer_charm():
    yield AirflowTriggererCharm


@pytest.fixture(scope="function")
def container():
    """Fixture to create a mock container."""
    return ops.testing.Container(name="airflow-triggerer", can_connect=True)


@pytest.fixture(scope="function")
def context(airflow_triggerer_charm):
    return ops.testing.Context(charm_type=airflow_triggerer_charm)
