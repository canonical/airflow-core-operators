...
from charm import SERVICE_NAME, AirflowTriggererCharm
...
def test_pebble_ready(monkeypatch: pytest.MonkeyPatch):
    ...
    # Arrange:
    ctx = testing.Context(AirflowTriggererCharm)
    ...
    monkeypatch.setattr("charm.airflow_triggerer.get_version", mock_get_version)
